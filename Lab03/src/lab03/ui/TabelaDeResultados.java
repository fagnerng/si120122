...
public class TabelaDeResultados extends javax.swing.JFrame {
    ...
    public TabelaDeResultados(ListadorDeArquivos listador) {
        initComponents();
        diretorio.setText(listador.getFilePath());
        int i = listador.getListaDeArquivos().size();
        String frase = "";
        switch (i) {
		case 0:
			frase = "0 arquivos";
        ...
        numArquivosTotal.setText(frase);
        
        barraDeProgresso.setMaximum(i);
    ...
    private void initComponents() {
        ...
        numArquivosParcial.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        resultado.setModel(new TableModel());
...
//        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(encontrados)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numArquivosParcial, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numArquivosTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(porcentagen)
                        .addGap(12, 12, 12))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(diretorio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(encontrados)
                        .addComponent(numArquivosParcial)
                        .addComponent(jLabel2)
                        .addComponent(numArquivosTotal))
                    .addComponent(porcentagen))
                .addContainerGap())
        );
    ...
    public void setPorcentagen(int  porcentagen) {
    	barraDeProgresso.setValue(porcentagen);
    }
      	
   public void updateTable(GerenciadorDeResultados resultado){
	  numArquivosParcial.setText(resultado.getArquivosPesquisados()+"");
	  setPorcentagen(resultado.getArquivosPesquisados());
	  encontrados.setText(resultado.getTotalEncontrado()+"");
    ...
    private javax.swing.JLabel numArquivosParcial;
    private javax.swing.JLabel numArquivosTotal;
